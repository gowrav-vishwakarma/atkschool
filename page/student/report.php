...
class page_student_report extends Page{
	...
	public $field_list=array('sno','roll_no','scholar_no','class','name','fname','father_name','eng_father_name','mother_name','eng_mother_name','guardian_name','age','admission_date','isScholared','ishostler', 'dob','contact','p_address','sex','category','image_url');
